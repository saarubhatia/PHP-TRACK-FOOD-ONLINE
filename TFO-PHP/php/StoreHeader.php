  ...
  <div class="container">
    ...
    <a class="navbar-brand" href="#">
      ...
      <ul class="nav navbar-nav">
        <li class="<?php if($page=='StoreHome'){echo 'active';}?>"><a href="/TFO-PHP/php/StoreHome.php">My Store</a></li>
        <li class="<?php if($page=='StoreOrder'){echo 'active';}?>"><a href="/TFO-PHP/php/StoreOrder.php">Process Orders</a></li>
        <li><a href="#">About Us</a></li>
        <li><a href="#">Contact Us</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li style="display:<?php if(!isset($_SESSION['user'])){echo'none';}?>;"><a href="#"><span class="glyphicon glyphicon-user"></span> Hi, Store XYZ</a></li>
